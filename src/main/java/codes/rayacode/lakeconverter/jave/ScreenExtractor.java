...
import codes.rayacode.lakeconverter.jave.utils.RBufferedReader;
import codes.rayacode.lakeconverter.jave.utils.Utils;
...
public class ScreenExtractor {
  ...
  /**
   * It builds an extractor using a {@link codes.rayacode.lakeconverter.jave.process.ffmpeg.FFMPEGProcess} instance to
  ...
  /**
   * It builds an extractor with a custom {@link codes.rayacode.lakeconverter.jave.process.ffmpeg.FFMPEGProcess}.
   *
