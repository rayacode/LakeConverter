...
import codes.rayacode.lakeconverter.jave.filters.VideoFilter;
...
public class VideoAttributes implements Serializable {
   ...
   *
   * {@link codes.rayacode.lakeconverter.jave.encode.enums.PresetEnum}
   */
  ...
  /**
   * set the quality from {@link codes.rayacode.lakeconverter.jave.encode.enums.PresetEnum}
   * @param preset
   * @return this instance
   */
