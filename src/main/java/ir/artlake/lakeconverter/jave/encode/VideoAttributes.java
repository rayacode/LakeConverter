 ...
 */
package ir.artlake.lakeconverter.jave.encode;
...
import ir.artlake.lakeconverter.jave.filters.VideoFilter;
...
public class VideoAttributes implements Serializable {
   ...
   *
   * {@link ir.artlake.lakeconverter.jave.encode.enums.PresetEnum}
   */
  ...
  /**
   * set the quality from {@link ir.artlake.lakeconverter.jave.encode.enums.PresetEnum}
   * @param preset
   * @return this instance
   */
