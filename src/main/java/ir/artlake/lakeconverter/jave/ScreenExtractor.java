...
import ir.artlake.lakeconverter.jave.process.ProcessLocator;
import ir.artlake.lakeconverter.jave.process.ProcessWrapper;
import ir.artlake.lakeconverter.jave.process.ffmpeg.DefaultFFMPEGLocator;
import ir.artlake.lakeconverter.jave.utils.RBufferedReader;
import ir.artlake.lakeconverter.jave.utils.Utils;
...
public class ScreenExtractor {
  ...
  /**
   * It builds an extractor using a {@link ir.artlake.lakeconverter.jave.process.ffmpeg.FFMPEGProcess} instance to
  ...
  /**
   * It builds an extractor with a custom {@link ir.artlake.lakeconverter.jave.process.ffmpeg.FFMPEGProcess}.
   *
